...
import s from './Libs.module.scss';
import Skycon from "components/admin/Skycon/Skycon";
      ...
      <Row className={s.root}>
        ...
        <Col lg={9}>
          ...
          <Widget id="Font-Awesome">
            ...
            <p className="lead">Want to see examples? <Link href="/app/components/icons">Click</Link></p>
          ...
          <Widget id="Formsy-React">
            ...
            <p className="lead">Want to see examples? <Link href="/app/forms/wizard">Click</Link></p>
          ...
          <Widget id="Fullcalendar">
            ...
            <p className="lead">Want to see examples? <Link href="/app/extra/calendar">Click</Link></p>
            <p>For more examples and documentation please refer to <a
          ...
          <Widget id="Glyphicons-Halflings">
            ...
            <p className="lead">Want to see examples? <Link href="/app/ui/icons">Click</Link></p>
            <p>For more examples and documentation please refer to <a
          ...
          <Widget id="React-Toastify">
            ...
            <p className="lead">Want to see examples? <Link href="/app/ui/notifications">Click</Link></p>
          ...
          <Widget id="React-dropzone">
            ...
            <p className="lead">Want to see examples? <Link href="/app/forms/elements">Click</Link></p>
            <p>For more examples and documentation please refer to <a
          ...
          <Widget id="React-Google-Maps">
            ...
            <p className="lead">Want to see examples? <Link href="/app/maps/google">Click</Link></p>
            <p>For more examples and documentation please refer to <a
          ...
          <Widget id="React-Shuffle">
            ...
            <p className="lead">Want to see examples? <Link href="/app/extra/gallery">Click</Link></p>
            <p>For more examples and documentation please refer to <a
          ...
          <Widget id="React-Slick">
            ...
            <p className="lead">Want to see examples? <Link href="/app/ecommerce/product">Click</Link></p>
            <p>For more examples and documentation please refer to <a
          ...
          <Widget id="React-Sortable">
            ...
            <p className="lead">Want to see examples? <Link href="/app/ui/list-groups">Click</Link></p>
            <p>For more examples and documentation please refer to <a
          ...
          <Widget id="Rickshaw">
            ...
            <p className="lead">Want to see examples? <Link href="/app/charts/rickshaw">Click</Link></p>
            <p>For more examples and documentation please refer to <a
...
export default withRouter(Libs);